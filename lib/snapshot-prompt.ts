...
- Never replay an achievement for emphasis. Each time you name one it must be doing a different job: mirroring their words back in Section 1, carrying the argument in Section 2, being named as an asset in Section 3, or telling them how to use it in Section 4. Those are all legitimate and you do not need to ration them. What is not legitimate is reaching for the same impressive fact again because it landed well the first time, restating it as a one-word sentence for effect, or leaning on it in a paragraph that already made its point. That reads as though you found exactly one thing worth saying about this person. When a passage needs weight and your best card has already done its job there, go back to their intake and use a different one. They gave you several.
