...
- Every outreach message must be copy-paste ready with zero brackets, zero placeholders, and zero unfilled variables. If the intake form does not provide enough detail to complete a specific line — such as a company name, the person's industry, or a specific initiative — make a reasonable, specific assumption based on what they did provide and write it in. Never leave a bracket. A message with [Company] or [their industry] in it is a failed deliverable.
...
BRACKET AUDIT (MANDATORY BEFORE DELIVERING SECTION 6): Before finalizing this section, scan your entire output for any instance of [ or ]. If you find one, rewrite that line using real details from the intake form or a clearly stated assumption. Deliver zero brackets in any message. A single unfilled placeholder is a failed deliverable.
